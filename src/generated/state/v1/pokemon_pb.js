...
proto.state.v1.Pokemon.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.state.v1.Species} */ (reader.readEnum());
      msg.setSpecies(value);
      break;
    case 2:
      var value = /** @type {!proto.state.v1.Items} */ (reader.readEnum());
      msg.setItem(value);
      break;
    case 3:
      var value = /** @type {!proto.state.v1.Abilities} */ (reader.readEnum());
    ...
    case 20:
      ...
      break;
    case 21:
      var value = /** @type {!proto.state.v1.Moves} */ (reader.readEnum());
      msg.setMove1(value);
      break;
    case 22:
      var value = /** @type {!proto.state.v1.Moves} */ (reader.readEnum());
...
proto.state.v1.Pokemon.prototype.getSpecies = function() {
  return /** @type {!proto.state.v1.Species} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
proto.state.v1.Pokemon.prototype.getItem = function() {
  return /** @type {!proto.state.v1.Items} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
...
proto.state.v1.Pokemon.prototype.getAbility = function() {
  return /** @type {!proto.state.v1.Abilities} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
...
proto.state.v1.Pokemon.prototype.getMove1 = function() {
  return /** @type {!proto.state.v1.Moves} */ (jspb.Message.getFieldWithDefault(this, 21, 0));
};
...
proto.state.v1.Pokemon.prototype.getMove2 = function() {
  return /** @type {!proto.state.v1.Moves} */ (jspb.Message.getFieldWithDefault(this, 22, 0));
};
...
proto.state.v1.Pokemon.prototype.getMove3 = function() {
  return /** @type {!proto.state.v1.Moves} */ (jspb.Message.getFieldWithDefault(this, 23, 0));
};
...
proto.state.v1.Pokemon.prototype.getMove4 = function() {
  return /** @type {!proto.state.v1.Moves} */ (jspb.Message.getFieldWithDefault(this, 24, 0));
};
...
proto.state.v1.Team.toObject = function(includeInstance, msg) {
  var f, obj = {
    pokemon1: (f = msg.getPokemon1()) && proto.state.v1.Pokemon.toObject(includeInstance, f),
    pokemon2: (f = msg.getPokemon2()) && proto.state.v1.Pokemon.toObject(includeInstance, f),
    pokemon3: (f = msg.getPokemon3()) && proto.state.v1.Pokemon.toObject(includeInstance, f),
    pokemon4: (f = msg.getPokemon4()) && proto.state.v1.Pokemon.toObject(includeInstance, f),
    pokemon5: (f = msg.getPokemon5()) && proto.state.v1.Pokemon.toObject(includeInstance, f),
    pokemon6: (f = msg.getPokemon6()) && proto.state.v1.Pokemon.toObject(includeInstance, f)
  };
...
proto.state.v1.Team.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      reader.readMessage(value,proto.state.v1.Pokemon.deserializeBinaryFromReader);
