...
export class Pokemon extends jspb.Message {
  ...
  setSpecies(value: state_v1_enum_pb.SpeciesMap[keyof state_v1_enum_pb.SpeciesMap]): void;

  getItem(): state_v1_enum_pb.ItemsMap[keyof state_v1_enum_pb.ItemsMap];
  setItem(value: state_v1_enum_pb.ItemsMap[keyof state_v1_enum_pb.ItemsMap]): void;

  getAbility(): state_v1_enum_pb.AbilitiesMap[keyof state_v1_enum_pb.AbilitiesMap];
  setAbility(value: state_v1_enum_pb.AbilitiesMap[keyof state_v1_enum_pb.AbilitiesMap]): void;
  ...
  setMove1(value: state_v1_enum_pb.MovesMap[keyof state_v1_enum_pb.MovesMap]): void;

  getMove2(): state_v1_enum_pb.MovesMap[keyof state_v1_enum_pb.MovesMap];
  setMove2(value: state_v1_enum_pb.MovesMap[keyof state_v1_enum_pb.MovesMap]): void;

  getMove3(): state_v1_enum_pb.MovesMap[keyof state_v1_enum_pb.MovesMap];
  setMove3(value: state_v1_enum_pb.MovesMap[keyof state_v1_enum_pb.MovesMap]): void;

  getMove4(): state_v1_enum_pb.MovesMap[keyof state_v1_enum_pb.MovesMap];
  setMove4(value: state_v1_enum_pb.MovesMap[keyof state_v1_enum_pb.MovesMap]): void;
