...
proto.state.v1.History = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.state.v1.History.repeatedFields_, null);
};
...
proto.state.v1.Stats.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    isCritical: jspb.Message.getBooleanFieldWithDefault(msg, 2, false),
    damage: jspb.Message.getFloatingPointFieldWithDefault(msg, 3, 0.0),
    ...
    targetFainted: jspb.Message.getBooleanFieldWithDefault(msg, 7, false),
 ...
 * @return {!Object}
 */
proto.state.v1.HistoryItem.prototype.toObject = function(opt_includeInstance) {
...
proto.state.v1.HistoryItem.toObject = function(includeInstance, msg) {
  var f, obj = {
    user: (f = msg.getUser()) && state_v1_pokemon_pb.Pokemon.toObject(includeInstance, f),
    target: (f = msg.getTarget()) && state_v1_pokemon_pb.Pokemon.toObject(includeInstance, f),
    context: (f = msg.getContext()) && state_v1_context_pb.Context.toObject(includeInstance, f),
    stats: (f = msg.getStats()) && proto.state.v1.Stats.toObject(includeInstance, f)
  };
 ...
 * @return {!proto.state.v1.HistoryItem}
 */
proto.state.v1.HistoryItem.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      ...
      reader.readMessage(value,state_v1_pokemon_pb.Pokemon.deserializeBinaryFromReader);
      msg.setUser(value);
      break;
    case 2:
      var value = new state_v1_pokemon_pb.Pokemon;
    ...
    case 4:
      ...
      reader.readMessage(value,proto.state.v1.Stats.deserializeBinaryFromReader);
      msg.setStats(value);
      break;
    default:
      reader.skipField();
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.state.v1.HistoryItem.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUser();
  if (f != null) {
    writer.writeMessage(
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      proto.state.v1.Stats.serializeBinaryToWriter
    );
  }
};
...
proto.state.v1.History.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.state.v1.HistoryItem.toObject, includeInstance)
  };
...
proto.state.v1.History.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      reader.readMessage(value,proto.state.v1.HistoryItem.deserializeBinaryFromReader);
...
proto.state.v1.History.prototype.getHistoryItemsList = function() {
  return /** @type{!Array<!proto.state.v1.HistoryItem>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.state.v1.HistoryItem, 1));
};
 ...
 * @return {!proto.state.v1.HistoryItem}
 */
proto.state.v1.History.prototype.addHistoryItems = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.state.v1.HistoryItem, opt_index);
};
